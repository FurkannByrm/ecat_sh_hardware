...
int sleep_task(clockid_t clock_to_use, int flag, const struct timespec* required_duration,
               struct timespec* remaining_duration)
{
  return clock_nanosleep(clock_to_use, flag, required_duration, remaining_duration);
}
